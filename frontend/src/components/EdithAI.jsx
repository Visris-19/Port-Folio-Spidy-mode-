    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-black border-2 border-cyan-400 rounded-2xl max-w-5xl w-full max-h-[95vh] flex flex-col overflow-hidden shadow-2xl shadow-cyan-500/25"
        ...
        >
          ...
          <div className="relative flex justify-between items-center p-6 border-b border-cyan-400/30 bg-gradient-to-r from-cyan-900/20 to-blue-900/20">
            ...
            <div className="flex items-center gap-3">
              ...
              <motion.button
                ...
                className="p-3 rounded-full border-2 border-yellow-400 bg-yellow-400/20 text-yellow-400 transition-all duration-300"
                whileHover={{ scale: 1.1, rotate: -5 }}
                whileTap={{ scale: 0.9 }}
              ...
              <motion.button
                ...
                className="p-3 rounded-full border-2 border-red-400 bg-red-400/20 text-red-400 transition-all duration-300"
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 min-h-96 max-h-96 relative">
            {/* Scan Line Effect */}
            <motion.div
            ...
            {messages.map((message) => (
              ...
              >
                <div
                  className={`max-w-[85%] p-4 rounded-2xl backdrop-blur-sm relative ${
                    message.type === 'user'
                      ? 'bg-gradient-to-br from-red-600/80 to-red-700/60 text-white ml-4 border border-red-400/50'
                      : message.isError
                      ? 'bg-gradient-to-br from-red-900/80 to-red-800/60 border border-red-500/50 text-red-200'
                      : 'bg-gradient-to-br from-cyan-900/40 to-blue-900/40 border border-cyan-400/30 text-cyan-100 mr-4'
                  }`}
                  style={{
                ...
                >
                  ...
                  {message.type === 'edith' && (
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center text-xs">
                        E
                      </div>
                      <span className="text-cyan-400 font-bold font-mono text-sm">EDITH</span>
                      <motion.div 
                      ...
                      {isSpeaking && message === messages[messages.length - 1] && (
                        <div className="flex items-center gap-1">
                          <motion.div className="w-1 h-3 bg-cyan-400 rounded" animate={{ scaleY: [0.5, 1, 0.5] }} transition={{ duration: 0.5, repeat: Infinity, delay: 0 }} />
                          <motion.div className="w-1 h-3 bg-cyan-400 rounded" animate={{ scaleY: [0.5, 1, 0.5] }} transition={{ duration: 0.5, repeat: Infinity, delay: 0.1 }} />
                          <motion.div className="w-1 h-3 bg-cyan-400 rounded" animate={{ scaleY: [0.5, 1, 0.5] }} transition={{ duration: 0.5, repeat: Infinity, delay: 0.2 }} />
                        </div>
                      )}
                    </div>
                  )}
            ...
            {isTyping && (
              ...
              >
                <div className="bg-gradient-to-br from-cyan-900/40 to-blue-900/40 border border-cyan-400/30 text-cyan-100 max-w-[85%] p-4 rounded-2xl mr-4 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center text-xs">
                      E
                    </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="flex space-x-1">
                      <motion.div className="w-2 h-2 bg-cyan-400 rounded-full" animate={{ y: [0, -8, 0] }} transition={{ duration: 0.6, repeat: Infinity, delay: 0 }} />
          ...
          <div className="p-6 border-t border-cyan-400/30 bg-gradient-to-r from-cyan-900/10 to-blue-900/10 backdrop-blur-sm">
            <div className="flex gap-4 relative">
              ...
              <div className="flex-1 relative">
                <motion.input
                  ...
                  placeholder="Ask EDITH about Vishal's projects, skills, or experience..."
                  className="w-full bg-gray-900/80 border-2 border-cyan-400/50 rounded-xl px-6 py-4 text-white placeholder-cyan-300/60 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/50 backdrop-blur-sm font-mono"
                  disabled={isLoading}
                  maxLength={1000}
                  style={{
              ...
              <motion.button
                ...
                className={`px-8 py-4 rounded-xl font-bold transition-all duration-300 relative overflow-hidden ${
            ...
            <div className="flex justify-between items-center mt-4 text-xs font-mono">
              <div className="flex items-center gap-4 text-cyan-400/80">
                ...
                <span>🛡️ Spider-Protocol Enabled</span>
              </div>
              <div className="flex items-center gap-3">
                <motion.span 
